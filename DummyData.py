...
async def upload_csv():
    ...
    headers = {
        'accept': '*/*',
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIwMTIzNDU2Nzg5IiwiaWF0IjoxNzE3NTc4MzE1LCJleHAiOjE3MTc1ODAxMTV9.C9kuZV8iNIf6VcraFnYzBs-rpvvkr4MkIYJyNY6QL4A',
